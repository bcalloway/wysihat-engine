    ...
    class InstanceTag #:nodoc:
      def to_wysihat_editor_tag(options = {})
        ...
        if options['buttons'] == nil || options['buttons'] == :all
          buttons = [:bold, :italic, :underline, :strikethrough, :justify_left, :justify_center, :justify_right, :insert_ordered_list, :insert_unordered_list, :undo, :redo, :link, :html, :image, :file]
        end
